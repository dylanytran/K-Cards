...
import { PACK_ADDRESS } from "../constants/addresses";
import { useState } from "react";
import { PackRewards } from "@thirdweb-dev/sdk/dist/declarations/src/evm";
    ...
    <div className={styles.container}>
      ...
      {openPackRewards && openPackRewards.erc1155Rewards?.length && (
        <div className={styles.container}>
          <h3>Pack Rewards:</h3>
          <div className={styles.grid}>
            {openPackRewards.erc1155Rewards.map((card: any, index: any) => (
